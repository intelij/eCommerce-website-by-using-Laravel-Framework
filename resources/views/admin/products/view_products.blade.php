                        ...
                        @foreach ($products as $product)
                            <tr class="gradeX">
                                ...
                                <td class="center">
                                    ...
                                    <a rel="{{ $product->id }}" rel1="delete-product" title="Delete Product" <?php /* href="{{ url('/admin/delete-product/'.$product->id) }}" */ ?> href="javascript:" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                                </td>
                            </tr>
